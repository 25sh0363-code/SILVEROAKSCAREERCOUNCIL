...
function ContentFormModal({ type, item, onClose, onSaved, uploadProgress, setUploadProgress, currentUserEmail }: ModalProps) {
  const isEdit = !!item;
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-900/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl border border-rose-100 max-w-2xl w-full max-h-[90vh] flex flex-col justify-between overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-left">
          ...
          {/* Description brief & category */}
          {type !== 'blogs' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-xs font-bold text-gray-900 uppercase tracking-widest">Category Discipline</label>
                <input
                  type="text"
                  value={category}
